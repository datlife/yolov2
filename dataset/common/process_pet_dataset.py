...
def main(_):
    ...
    label_map_dict = dataset.utils.label_map_util.get_label_map_dict(FLAGS.label_map_path)
    ...
    if FLAGS.faces_only:
        train_output_path = os.path.join(FLAGS.output_dir, 'pet_train_with_masks.record')
        val_output_path   = os.path.join(FLAGS.output_dir, 'pet_val_with_masks.record')
