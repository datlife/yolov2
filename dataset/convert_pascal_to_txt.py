...
**NOTE**
Most of the codes in this file was modified from TensorFlow Object Detection repo. Instead of generating tf.record,
we modified the file to generate .txt file.
    ...
    for year in years:
      ...
      for idx, example in enumerate(examples_list):
        ...
        for obj in data['object']:
          ...
          items += 1
          abs_path_to_image = os.path.join(data_dir, year, 'JPEGImages', data['filename'])
          instance = "{},{},{},{},{},{}\n".format(abs_path_to_image, xmin, ymin, xmax, ymax, classes_text)
...
def recursive_parse_xml_to_dict(xml):
  """
  Citation: https://github.com/tensorflow/models/blob/master/object_detection/utils/dataset_util.py
